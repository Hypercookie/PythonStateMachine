...
k = StateMachine(
    2,
    ["julia_home", "jannes_home", "julia_away", "jannes_away"],
    False,
    init_state=("julia_away", "jannes_away"),
)
k.attach_global_side_effect(c)
k.attach_side_effect(("!julia_home", "*"), ("julia_home", "*"), julia_got_home)
k.attach_side_effect(
    ("!julia_home", "*"), ("julia_home", "!jannes_home"), julia_came_home_and_is_alone
)
k.attach_side_effect(("*", "!jannes_home"), ("*", "jannes_home"), jannes_got_home)
k.attach_side_effect(
    ("*", "!jannes_home"), ("!julia_home", "jannes_home"), jannes_came_home_and_is_alone
)
